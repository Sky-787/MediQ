        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow p-6 cursor-pointer hover:shadow-lg transition-shadow" onClick={handleNavigateToReports}>
            <div className="flex items-center justify-between">
              ...
              <div className="bg-teal-100 p-3 rounded-full"><Calendar className="w-6 h-6 text-teal-700" /></div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-blue-100 p-3 rounded-full"><Stethoscope className="w-6 h-6 text-blue-700" /></div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6 cursor-pointer hover:shadow-lg transition-shadow" onClick={handleNavigateToUsers}>
            <div className="flex items-center justify-between">
              ...
              <div className="bg-purple-100 p-3 rounded-full"><Users className="w-6 h-6 text-purple-700" /></div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6 cursor-pointer hover:shadow-lg transition-shadow" onClick={handleNavigateToUsers}>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-teal-600 mt-1">Click para administrar →</p>
              </div>
              <div className="bg-teal-100 p-3 rounded-full"><UserCog className="w-6 h-6 text-teal-700" /></div>
            </div>
          </div>
        </div>
        ...
        {selectedAppointment && (
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-4">
              ...
              <button onClick={() => handleAssignAppointment(selectedAppointment._id, {})} className="px-4 py-2 bg-teal-700 text-white rounded-lg hover:bg-teal-800 transition-colors">Guardar cambios</button>
            </div>
          </div>
        )}
      </ModalWrapper>
