...
export default function LandingPage() {
  ...
  return (
    <main className="bg-gradient-to-b from-teal-50 via-white to-white text-gray-900 dark:bg-gray-950 dark:text-gray-50">
      <section className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-4xl flex-col items-center justify-center px-6 py-16 text-center">
        <div className="mb-4 inline-flex items-center rounded-full border border-teal-200 bg-white px-3 py-1 text-sm font-medium text-teal-700 shadow-sm dark:bg-teal-950/40 dark:text-teal-300">
          MediQ
        </div>
        ...
        <div className="mt-10 grid w-full max-w-3xl grid-cols-1 gap-3 text-left text-sm text-gray-600 dark:text-gray-300 md:grid-cols-3">
          <div className="rounded-lg border border-teal-100 bg-white p-4 shadow-sm dark:border-gray-800">
